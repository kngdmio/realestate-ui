...
export default function SearchBundle() {
  ...
  return (
    <>
      <div
        className="flex flex-grow items-stretch relative h-9  w-full sm:w-auto mx-auto cursor-pointer"
        onClick={toggleOpen}
      >
        ...
        <input
          ...
          className=" block w-full pl-10 disabled-input rounded-md border-0 py-3 pr-14 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 hover:ring-1 focus:ring-1 duration-200 focus:ring-inset hover:ring-black/40 focus:ring-black/40 sm:text-sm  sm:leading-6"
        />
                ...
                <Dialog.Panel className="relative transform overflow-hidden sm:rounded-xl sm:h-[85vh] w-screen h-screen sm:w-auto min-w-[40vw] bg-white sm:px-4 sm:pb-4 sm:pt-5 text-left shadow-xl transition-all sm:my-8 sm:p-6">
                  <div className="flex items-center space-x-3 sm:space-x-4 px-4">
                    ...
                    <div className="flex flex-grow  items-stretch relative mt-4 bg-[#f1f1f1]  w-3/4 mx-auto cursor-pointer">
                      <form id="modal_search" className="block w-full ">
                        <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                          <Search
                        ...
                        <input
                          ...
                          className="block w-full pl-10 rounded-md border-0 py-3 pr-14 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 hover:ring-1 focus:ring-1 duration-200 focus:ring-inset hover:ring-slate-800 focus:ring-slate-800 sm:text-sm  sm:leading-6"
                        />
                        <div
                          onClick={clearForm}
